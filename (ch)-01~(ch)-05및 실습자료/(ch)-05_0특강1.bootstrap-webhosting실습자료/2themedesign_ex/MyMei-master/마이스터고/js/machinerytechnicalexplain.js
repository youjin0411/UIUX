var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = {
        center: new kakao.maps.LatLng(35.8231196, 128.541497), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
    };
...
// 마커가 표시될 위치입니다 
var markerPosition = new kakao.maps.LatLng(35.8231196, 128.541497);
...
var iwContent = '<div style="width:150px;text-align:center;padding:6px 0;">경북기계공업고등학교</div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
    iwPosition = new kakao.maps.LatLng(35.8231196, 128.541497); //인포윈도우 표시 위치입니다
